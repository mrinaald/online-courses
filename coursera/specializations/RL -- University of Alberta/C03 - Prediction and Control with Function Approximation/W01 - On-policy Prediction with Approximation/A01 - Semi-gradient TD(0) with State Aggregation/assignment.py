...
class TDAgent(BaseAgent):
    ...
    def agent_step(self, reward, state):
        ...
        # ----------------
        # your code here
        last_state_value = np.dot(self.weights, last_state_feature)
        current_state_value = np.dot(self.weights, current_state_feature)
        weights_update = self.step_size * (reward + (self.discount_factor * current_state_value) - last_state_value) * last_state_feature
    ...
    def agent_end(self, reward):
        ...
        # your code here
        last_state_value = np.dot(self.weights, last_state_feature)
        weights_update = self.step_size * (reward - last_state_value) * last_state_feature
