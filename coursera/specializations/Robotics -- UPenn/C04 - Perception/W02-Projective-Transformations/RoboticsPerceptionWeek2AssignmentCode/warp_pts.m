...
sample_pts_homogeneous = [sample_pts ones(size(sample_pts, 1), 1)];

warped_pts_T = H * (sample_pts_homogeneous');

warped_pts = warped_pts_T';

warped_pts = [warped_pts(:, 1)./warped_pts(:, 3) warped_pts(:, 2)./warped_pts(:, 3)]
