...
def crop(image, new_shape):
    ...
    new_image_H = new_shape[2]
    new_image_W = new_shape[3]
    
    start_H = (image_H // 2) - (new_image_H // 2)
    end_H = start_H + new_image_H
    start_W = (image_W // 2) - (new_image_W // 2)
    end_W = start_W + new_image_W
...
# print(tuple(UNet(1, 3)(torch.randn(1, 1, 512, 512)).shape))
# print(tuple(UNet(1, 3)(torch.randn(1, 1, 300, 300)).shape))
# print(tuple(UNet(1, 3)(torch.randn(1, 1, 600, 600)).shape))
print("Success!")
