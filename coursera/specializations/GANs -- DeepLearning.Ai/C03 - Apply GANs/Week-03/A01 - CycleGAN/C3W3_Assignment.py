...
def get_disc_loss(real_X, fake_X, disc_X, adv_criterion):
    ...
    disc_loss = adv_criterion(real_X_pred, torch.ones_like(real_X_pred)) + adv_criterion(fake_X_pred, torch.zeros_like(fake_X_pred))
    #### END CODE HERE ####
    return disc_loss / 2
...
def get_gen_loss(real_A, real_B, gen_AB, gen_BA, disc_A, disc_B, adv_criterion,
    ...
    #### START CODE HERE ####
    # Adversarial Loss - get_gen_adversarial_loss(real_X, disc_Y, gen_XY, adv_criterion) -> adversarial_loss, fake_Y
    adv_loss_AB, fake_B = get_gen_adversarial_loss(real_A, disc_B, gen_AB, adv_criterion)
    adv_loss_BA, fake_A = get_gen_adversarial_loss(real_B, disc_A, gen_BA, adv_criterion)

    # Identity Loss - get_identity_loss(real_X, gen_YX, identity_criterion) -> identity_loss, identity_X
    ...
    # Cycle-consistency Loss - get_cycle_consistency_loss(real_X, fake_Y, gen_YX, cycle_criterion) -> cycle_loss, cycle_X
    cycle_loss_A, _ = get_cycle_consistency_loss(real_A, fake_B, gen_BA, cycle_criterion)
    cycle_loss_B, _ = get_cycle_consistency_loss(real_B, fake_A, gen_AB, cycle_criterion)

    # Total loss
    adversarial_loss = adv_loss_BA + adv_loss_AB
    identity_loss = identity_loss_A + identity_loss_B
    cycle_consistency_loss = cycle_loss_A + cycle_loss_B
