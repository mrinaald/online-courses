...
def combine_sample(real, fake, p_real):
    ...
    '''
    #### START CODE HERE ####
    real_indices = torch.rand(len(real)) <= p_real
    target_images = real.clone()
    target_images[~real_indices] = fake[~real_indices]
#     target_images = torch.cat([real.clone()[real_indices], fake.clone()[fake_indices]], dim=0)[:len(real)]
    #### END CODE HERE ####
